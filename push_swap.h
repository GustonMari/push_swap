...
/*   Updated: 2022/01/07 11:34:26 by gmary            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_resolve_a(t_list **h_a, t_list **h_b, int ct, t_operation **h_o);
void		ft_resolve_b(t_list **h_a, t_list **h_b, int ct, t_operation **h_o);
...
void		ft_special_case_reverse(t_list **h, int chunk, t_operation **h_o);
...
void		ft_resolve_case_reverse(t_list **h, int chunk, t_operation **h_o);
